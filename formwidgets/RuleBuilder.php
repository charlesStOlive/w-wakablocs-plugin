<?php namespace Waka\WakaBlocs\FormWidgets;
...
class RuleBuilder extends FormWidgetBase
{
    ...
    protected function getToolbarWidget()
    {
        ...
        $config = $this->makeConfig([
            'buttons' => '$/waka/wakablocs/formwidgets/rulebuilder/partials/_rules_toolbar.htm',
            'search' => [
    ...
    public function onLoadCreateRuleForm()
    {
        ...
        $rules = $this->getRuleClass()::findRules($ruleMode, $targetProductor);
    ...
    protected function getRuleClass() {
        if($this->ruleMode == 'content') {
           return  \Waka\WakaBlocs\Classes\Rules\RuleContentBase::class;
        } 
       
        elseif($this->ruleMode == 'ask') {
            return \Waka\WakaBlocs\Classes\Rules\AskBase::class;
        }
        elseif($this->ruleMode == 'bloc') {
            return \Waka\WakaBlocs\Classes\Rules\BlocBase::class;
        }
